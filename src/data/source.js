import { generateHouseNumber, generateID, myTel } from "./api"
...
export const userData = {
  ...
  my_stack: {
    ...
    css_framework: ["bootstrp5", "tailwind"],
    logo: {
      ...
      "C++": "/src/assets/user/languages/C++ (CPlusPlus).svg",
      Reactjs: "/src/assets/user/framework/React.svg",
      lang: [
        "/src/assets/user/languages/HTML5.svg",
        "/src/assets/user/languages/CSS3.svg",
        "/src/assets/user/languages/Sass.svg",
        "/src/assets/user/languages/JavaScript.svg",
        "/src/assets/user/languages/TypeScript.svg",
      ],
      std_lang: [
        "/src/assets/user/languages/Python.svg",
        "/src/assets/user/languages/C.svg",
        "/src/assets/user/languages/C++ (CPlusPlus).svg",
      ],
    },
  },
};
